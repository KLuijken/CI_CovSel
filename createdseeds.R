...
# S1, seeds
set.seed(1)
seedsS1 <- matrix(sample(1:10000000, size=nrow(S1)*nsim, replace = F), nrow=nrow(S1))
...
# S2, seeds
set.seed(2)
seedsS2 <- matrix(sample(1:10000000, size=nrow(S2)*nsim, replace = F), nrow=nrow(S2))
...
# S3, seeds
set.seed(3)
seedsS3 <- matrix(sample(1:10000000, size=nrow(S3)*nsim, replace = F), nrow=nrow(S3))
